        ...
        chrome.storage.sync.get('name', function(budget){
            ...
            xmlhttp.onreadystatechange = function(){
                if (xmlhttp.status == 200 && xmlhttp.readyState == 4){
                        ...
                        tail = "</p></span></div><style type=\"text/css\"> #houseinfo{border:8px solid 	#BCD2EE;border-radius:45px;width:700px;height:300px;background-color:	#CAE1FF;font-size:20px;font-weight:bold;}</style>"
